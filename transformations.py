...
"""tipo particular de frustrum"""
"""fovy es el angulo de vision, en 60 se ve bonito, mas->mas lejos, menos->mas lejos"""
"""aspect es como en las teles, ej 16/9, un double"""
def perspective(fovy, aspect, near, far):
    halfHeight = np.tan(np.pi * fovy / 360) * near
    halfWidth = halfHeight * aspect
    return frustum(-halfWidth, halfWidth, -halfHeight, halfHeight, near, far)

""""define espacio homogeneo, cubo donde ve la camara"""
"""
left right limites en eje x
top bottom limites en eje y
near far limites en eje z
"""
...
"""define la matriz de la camara dado eye, at, up"""
"""eye, at, up vectores x,y,z"""
